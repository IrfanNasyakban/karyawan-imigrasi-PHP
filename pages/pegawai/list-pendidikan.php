...
if ($search != '') {
    $query = "SELECT 
              ...
              OR pd.pendidikanTerakhir LIKE '%$search%'
            ...
            <form method="GET" action="" class="search-form" style="margin: 0;">
                <div class="search-box">
                    <input type="text" 
                           name="search" 
                           class="search-input" 
                           placeholder="Cari nama atau jenjang pendidikan..." 
            ...
            <table id="table-pendidikan" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['pendidikanTerakhir']); ?></td>
                        <td>
                            <a href="edit/edit-pendidikan.php?id=<?php echo $row['idPendidikan']; ?>" 
                            ...
                            <button type="button" 
                                    ...
                                    data-id="<?php echo $row['idPendidikan']; ?>"
                    ...
                    <tr>
                        <td colspan="4">
                            <div class="empty-state">
                                ...
                                <?php if ($search != ''): ?>
                                    <p>Tidak ada data pendidikan yang sesuai dengan pencarian "<strong><?php echo htmlspecialchars($search); ?></strong>"</p>
                                    <a href="?" class="btn-add mt-3">
                                        <i class="fas fa-redo"></i> Reset Pencarian
                                    </a>
                                <?php else: ?>
                                    <p>Belum ada data pendidikan yang tersedia</p>
                                    <a href="tambah-pendidikan.php" class="btn-add mt-3">
                                        <i class="fas fa-plus"></i> Tambah Data Pendidikan
                                    </a>
                                <?php endif; ?>
                            </div>
                        </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p class="text-muted mb-2">Data pendidikan untuk:</p>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <h5 class="mt-3 mb-0">
                    <?php 
                        if ($_GET['error'] == 'gagal_hapus') echo 'Gagal menghapus data pendidikan!';
                        if ($_GET['error'] == 'tidak_ditemukan') echo 'Data pendidikan tidak ditemukan!';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (deleteModal) {
        deleteModal.addEventListener('show.bs.modal', function(event) {
            ...
            const idPendidikan = button.getAttribute('data-id');
            const namaPegawai = button.getAttribute('data-nama');
            
            // Update modal content
            document.getElementById('deleteNamaPegawai').textContent = namaPegawai;
            document.getElementById('confirmDeleteBtn').href = 'hapus/hapus-pendidikan.php?id=' + idPendidikan;
        });
    }
