...
if ($search != '') {
    $query = "SELECT 
              ...
              OR pk.pangkat LIKE '%$search%'
              OR pk.golonganRuang LIKE '%$search%'
...
<div class="container-fluid px-2 py-2">
    ...
    <div class="action-bar">
        <div class="action-bar-left" style="display: flex; gap: 15px; align-items: center;">
            <a href="tambah/tambah-pangkat-2.php" class="btn-add">
            ...
            <form method="GET" action="" class="search-form" style="margin: 0;">
                <div class="search-box">
                    <input type="text" 
                           name="search" 
                           class="search-input" 
                           placeholder="Cari nama, pangkat, golongan..." 
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button type="button" 
                                    ...
                                    data-id="<?php echo $row['idPangkat']; ?>"
                                    data-nama="<?php echo htmlspecialchars($row['namaDenganGelar']); ?>"
                                    data-pangkat="<?php echo htmlspecialchars($row['pangkat']); ?>"
                                    data-golongan="<?php echo htmlspecialchars($row['golonganRuang']); ?>">
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <?php if ($search != ''): ?>
                                    <p>Tidak ada data pangkat yang sesuai dengan pencarian "<strong><?php echo htmlspecialchars($search); ?></strong>"</p>
                                    <a href="?" class="btn-add mt-3">
                                        <i class="fas fa-redo"></i> Reset Pencarian
                                    </a>
                                <?php else: ?>
                                    <p>Belum ada data pangkat yang tersedia</p>
                                    <a href="tambah/tambah-pangkat-2.php" class="btn-add mt-3">
                                        <i class="fas fa-plus"></i> Tambah Data Pangkat
                                    </a>
                                <?php endif; ?>
                            </div>
                        </td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <div class="text-start mb-3">
                    <p class="text-muted mb-1">Data pangkat untuk:</p>
                    <p class="fw-bold mb-2" id="deleteNamaPegawai"></p>
                    <div class="row">
                        <div class="col-6">
                            <p class="text-muted small mb-0">Pangkat:</p>
                            <p class="fw-semibold small" id="deletePangkat"></p>
                        </div>
                        <div class="col-6">
                            <p class="text-muted small mb-0">Golongan:</p>
                            <p class="fw-semibold small" id="deleteGolongan"></p>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <h5 class="mt-3 mb-0">
                    <?php 
                        if ($_GET['error'] == 'gagal_hapus') echo 'Gagal menghapus data pangkat!';
                        if ($_GET['error'] == 'tidak_ditemukan') echo 'Data pangkat tidak ditemukan!';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (deleteModal) {
        deleteModal.addEventListener('show.bs.modal', function(event) {
            ...
            const idPangkat = button.getAttribute('data-id');
            ...
            document.getElementById('deletePangkat').textContent = pangkat;
            document.getElementById('deleteGolongan').textContent = golongan;
            document.getElementById('confirmDeleteBtn').href = 'hapus/hapus-pangkat.php?id=' + idPangkat;
        });
    }
