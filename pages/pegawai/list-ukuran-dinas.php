...
if ($search != '') {
    $query = "SELECT 
              ...
              OR u.ukuranPadDivamot LIKE '%$search%'
              OR u.ukuranSepatu LIKE '%$search%'
...
<div class="container-fluid px-2 py-2">
    ...
    <div class="page-header">
        <div class="page-header-content">
            <h2><i class="fas fa-ruler me-2"></i>Data Ukuran Dinas</h2>
            ...
            <form method="GET" action="" class="search-form" style="margin: 0;">
                <div class="search-box">
                    <input type="text" 
                           name="search" 
                           class="search-input" 
                           placeholder="Cari nama pegawai atau ukuran..." 
            ...
            <table id="table-ukuran-dinas" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['ukuranPadDivamot']); ?></td>
                        <td><?php echo htmlspecialchars($row['ukuranSepatu']); ?></td>
                        <td><?php echo htmlspecialchars($row['ukuranTopi']); ?></td>
                        <td>
                            <a href="edit/edit-ukuran-dinas.php?id=<?php echo $row['idUkuran']; ?>" 
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <?php if ($search != ''): ?>
                                    <p>Tidak ada data ukuran dinas yang sesuai dengan pencarian "<strong><?php echo htmlspecialchars($search); ?></strong>"</p>
                                    <a href="?" class="btn-add mt-3">
                                        <i class="fas fa-redo"></i> Reset Pencarian
                                    </a>
                                <?php else: ?>
                                    <p>Belum ada data ukuran dinas yang tersedia</p>
                                    <a href="tambah/tambah-ukuran-dinas-2.php" class="btn-add mt-3">
                                        <i class="fas fa-plus"></i> Tambah Data Ukuran Dinas
                                    </a>
                                <?php endif; ?>
                            </div>
                        </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p class="text-muted mb-2">Data ukuran dinas untuk:</p>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <h5 class="mt-3 mb-0">
                    <?php 
                        if ($_GET['error'] == 'gagal_hapus') echo 'Gagal menghapus data ukuran dinas!';
                        if ($_GET['error'] == 'tidak_ditemukan') echo 'Data ukuran dinas tidak ditemukan!';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (deleteModal) {
        deleteModal.addEventListener('show.bs.modal', function(event) {
            ...
            const idUkuran = button.getAttribute('data-id');
            const namaPegawai = button.getAttribute('data-nama');
            
            // Update modal content
            document.getElementById('deleteNamaPegawai').textContent = namaPegawai;
            document.getElementById('confirmDeleteBtn').href = 'hapus/hapus-ukuran-dinas.php?id=' + idUkuran;
        });
    }
