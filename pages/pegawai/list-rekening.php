...
$page_title = 'Data Rekening Pegawai';
...
if ($search != '') {
    $query = "SELECT 
              ...
              OR r.nomorRekGaji LIKE '%$search%'
              OR r.namaBank LIKE '%$search%'
              ORDER BY r.idRekening DESC";
} else {
    $query = "SELECT 
                r.idRekening,
                r.idPegawai,
...
<div class="container-fluid px-2 py-2">
    ...
    <div class="page-header">
        <div class="page-header-content">
            <h2><i class="fas fa-credit-card me-2"></i>Data Rekening</h2>
            <p>Sistem Informasi Rekening - Kantor Imigrasi Kelas II TPI Lhokseumawe</p>
        </div>
    ...
    <div class="action-bar">
        <div class="action-bar-left" style="display: flex; gap: 15px; align-items: center;">
            <a href="tambah/tambah-rekening-2.php" class="btn-add">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table id="table-rekening" class="table table-striped table-hover">
                <thead class="table-dark">
                    <tr>
                        <th>No</th>
                        <th>Nama Pegawai</th>
                        <th>Nomor Rek Gaji</th>
                        <th>Nama Bank</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($row['nomorRekGaji']); ?></td>
                        <td><?php echo htmlspecialchars($row['namaBank']); ?></td>
                        <td><?php echo htmlspecialchars($row['kantorCabang']); ?></td>
                        <td>
                            <a href="edit/edit-rekening.php?id=<?php echo $row['idRekening']; ?>" 
                            ...
                            <button type="button" 
                                    ...
                                    data-id="<?php echo $row['idRekening']; ?>"
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="empty-state">
                                ...
                                <?php if ($search != ''): ?>
                                    <p>Tidak ada data rekening yang sesuai dengan pencarian "<strong><?php echo htmlspecialchars($search); ?></strong>"</p>
                                    <a href="?" class="btn-add mt-3">
                                        <i class="fas fa-redo"></i> Reset Pencarian
                                    </a>
                                <?php else: ?>
                                    <p>Belum ada data rekening yang tersedia</p>
                                    <a href="tambah/tambah-rekening-2.php" class="btn-add mt-3">
                                        <i class="fas fa-plus"></i> Tambah Data Rekening
                                    </a>
                                <?php endif; ?>
                            </div>
                        </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p class="text-muted mb-2">Data rekening untuk:</p>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <h5 class="mt-3 mb-0">
                    <?php
                        if ($_GET['message'] == 'tambah') echo 'Data rekening berhasil ditambahkan!';
                        if ($_GET['message'] == 'edit') echo 'Data rekening berhasil diubah!';
                        if ($_GET['message'] == 'hapus') echo 'Data rekening berhasil dihapus!';
                    ?>
                </h5>
            </div>
            <div class="modal-footer">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <h5 class="mt-3 mb-0">
                    <?php 
                        if ($_GET['error'] == 'gagal_hapus') echo 'Gagal menghapus data rekening!';
                        if ($_GET['error'] == 'tidak_ditemukan') echo 'Data rekening tidak ditemukan!';
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (deleteModal) {
        deleteModal.addEventListener('show.bs.modal', function(event) {
            ...
            const idRekening = button.getAttribute('data-id');
            const namaPegawai = button.getAttribute('data-nama');
            
            // Update modal content
            document.getElementById('deleteNamaPegawai').textContent = namaPegawai;
            document.getElementById('confirmDeleteBtn').href = 'hapus/hapus-rekening.php?id=' + idRekening;
        });
    }
