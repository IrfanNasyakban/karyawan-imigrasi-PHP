...
if (isset($_POST['submit'])) {
    ...
    if ($idPegawai === '') {
        ...
        if (mysqli_query($conn, $query)) {
            header("Location: tambah-identitas.php?idPegawai=$idPegawai");
            exit();
        } else {
        ...
        <div class="col-md-8">
            <div class="card shadow-sm border-0">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0">
                        <i class="fas fa-user-plus me-2"></i>Tambah Data Alamat
                    </h4>
                </div>
                <div class="card-body">
                    <?php if (isset($error)): ?>
                    ...
                    <form method="POST" action="">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="alamatDomisili" class="form-control" required>
                        </div>
